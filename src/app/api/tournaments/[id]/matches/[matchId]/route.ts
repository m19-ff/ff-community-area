...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /tournaments/[id]/matches/[matchId]]', error)
...
export async function PATCH(
  ...
  try {
    ...
    if (action === 'send_room') {
      ...
      if (!matchWithGroup) return apiError('Match not found', 404)
    ...
    console.error('[PATCH /tournaments/[id]/matches/[matchId]]', error)
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /tournaments/[id]/matches/[matchId]]', error)
