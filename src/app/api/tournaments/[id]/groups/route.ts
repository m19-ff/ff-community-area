...
// Returns all groups + their assigned teams for a tournament.
export async function GET(
  ...
  // All registered teams (for unassigned list)
...
// Actions:
//   create_groups   — create N lettered groups, optionally auto-assign teams
//   assign_team     — move a team into a group (or remove from current group first)
//   remove_team     — remove a team from its group
//   delete_group    — delete a group (teams become unassigned)
//   auto_assign     — distribute all unassigned registered teams across groups evenly
export async function POST(
  ...
  if (action === 'assign_team') {
    ...
    // Upsert — remove from current group first (handled by unique constraint + delete)
    await db
