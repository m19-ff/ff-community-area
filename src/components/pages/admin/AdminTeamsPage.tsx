...
type Team = { id: number; name: string; logo: string | null; walletBalance: number; captainId: number; memberCount: number; totalTournaments: number }
          ...
          <tbody>
            {teams.map(team => (
              <tr key={team.id}>
                ...
                <td>
                  <span className="font-semibold" style={{ color: 'var(--accent-red)' }}>{team.walletBalance.toLocaleString()}</span>
                </td>
